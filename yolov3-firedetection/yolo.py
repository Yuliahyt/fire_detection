...
class YOLO(object):
    _defaults = {
        "model_path": 'model_data/smokefire.h5',  # 已经训练好的模型
        "anchors_path": 'model_data/smokefire_anchors.txt',  # 通过聚类算法得到的3组9个anchor box，分别用于13x13、26x26、52x52的feature map
        "classes_path": 'model_data/smokefire_classes.txt',  # 可识别的COCO类别列表，一共80个
        ...
        "gpu_num": 0,  # GPU数量，通常是指Nvidia的GPU
    }
